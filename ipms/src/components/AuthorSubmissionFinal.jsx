...
function AuthorSubmissionFinal() {
  return (
    <>
        <div className=' flex flex-row mt-5 bg-amber-200 p-5 justify-between rounded-lg'>
            ...
            <div>
              <div>
              <Link className='bg-yellow-50 p-2 rounded-xl mb-2' to="/editor/reviewerdetails">Assign Editor</Link>
              </div>
              <br />
...
export default AuthorSubmissionFinal