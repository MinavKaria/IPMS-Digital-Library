          ...
          <form className="container flex flex-col gap-8 opacity-110 w-3/5 rounded-3xl p-6 m-2">
            ...
            <div className="input flex flex-col">
              ...
              <input
                ...
                type="text"
                className="form-control border-2 border-gray-300 rounded-md bg-slate-200 p-2 h-24"
              />
            </div>
            <div className="input flex flex-col">
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="text"
                  className="form-control border-2 border-gray-300 rounded-md p-2 bg-slate-200 flex-grow"
                />
                <input
                  type="file"
                  id="file"
                  className="ml-2 p-2 bg-slate-200 border-gray-300 rounded-md cursor-pointer"
                />
              </div>
            </div>
          </form>
